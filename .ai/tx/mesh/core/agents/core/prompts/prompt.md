...
**Mesh Instance**: `core`
**Mesh Name**: `core`
**Initialized At**: 2025-12-07T07:00:37.920Z
...
# A2A Relay Connection

This TX instance is connected to the A2A relay for cross-machine collaboration.

| Property | Value |
|----------|-------|
| Mode | serve |
| Username | guest |
| Pairing Phrase | `ideal-jewel-cloud` |
| Partner | waiting... |

## Addressing

- **Local messages**: `to: core/core` (stays on this machine)
- **Remote messages**: `to: <partner>:core/core` (routes over relay)

When a remote user connects, their messages arrive with `from: <username>:<agent>` prefix.
